        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 flex justify-between items-center mb-6">
          <div className="flex gap-5">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-2">{order.restaurant.address}</p>
          ...
          <div className="text-right">
            ...
            <div className="mt-4 text-3xl font-bold">₹{order.totalAmount}</div>
          </div>
        </div>
        ...
        <div className="rounded-2xl overflow-hidden shadow-lg">
          ...
          >
            ...
            <Marker position={[user.lat, user.lng]} icon={userIcon}>
              <Popup>{order.deliveryAddress.fullName}</Popup>
            </Marker>

            <Polyline positions={route} color="orange" weight={7} />
          </MapContainer>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mt-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 lg:col-span-2">
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={step} className="flex gap-4 mb-8">
                  <div
                  ...
                  <div>
                    <h3 className="font-bold">{step.replaceAll("_", " ")}</h3>
